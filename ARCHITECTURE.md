# Visitor Management Admin Frontend - Three Repository Architecture

This is the admin frontend repository for the Visitor Management SaaS platform.
...
2. **visitor-management-admin-fe** (this repo) - React admin dashboard
